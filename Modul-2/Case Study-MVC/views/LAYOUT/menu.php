                ...
                <div class="nav">
                    ...
                    <div class="collapse" id="collapseSanPham" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link" href="index.php?controller=Customer&page=list">Khách hàng</a>                            
                            <a class="nav-link" href="index.php?controller=Preventions&page=list">Đơn Hàng</a>
                            <a class="nav-link" href="index.php?controller=Preventions&page=list">Sản phẩm</a>
                            <a class="nav-link" href="index.php?controller=Preventions&page=list">Thể loại</a>
